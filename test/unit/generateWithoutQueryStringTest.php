...
$t->diag('Find a route from $_GET value');
$_GET = array(
...
$t->cmp_ok($route_information, '===', $expected_information, '::findRoute() ok');

$t->diag('Generate routes with extra_parameters_as_query_string = false');
